        ...
        try {
            ...
            if (responseData.EncData) {
                ...
                if (parsedData.TradeToken) {
                    ...
                    // Encode a URL instead of the full TradeToken
                    ...
                    try {
                        qrcode.toFile('yoxipaid.png', qrData, {
                            errorCorrectionLevel: 'L', // Lower error correction for more capacity
                            ...
                            console.log('QR Code saved as yoxipaid.png');
                        });
                    } catch (e) {
