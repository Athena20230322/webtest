...
$(function () {
	...
	merchant_list.forEach((element)=>{
		...
		document.getElementById("key").appendChild(options)
	})
...
function change_api_new(id,e){
	...
	ta_input.value="100"
	bt_input.value=""
	cu_input.value = default_callbackURL 
...
function create_postman_data(){
	...
	var test_CU = default_callbackURL
...
function copy_function(e) {
	var copy_text = e.parentNode.getElementsByTagName("textarea")[0].value.replace(/[\n\r]/g, '');;
